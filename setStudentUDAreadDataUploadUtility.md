**SetStudentUDAreaDataUploadUtility**
----
...
* **Error Response:**
	...
	```javascript
	__invalid: {
		"studentudarea": "'studentudarea' is required."
	}
	```
	...
	```javascript
	__invalid: {
		"id": "[id] - Student or Enrolled Student code is not in TASS."
	}
	```
...
* **Sample POST:**
	...
	<form id="postForm" name="postForm" method="POST" action="http://api.tasscloud.com.au/tassweb/api/">
		 <input type="hidden" name="method" value="setStudentUDAreaDataUploadUtility">
